...
![创建应用](/images/v1/nodejs-sinacloud_2018-02-11_15-55-33.png)
![创建应用](/images/v1/nodejs-sinacloud_2018-02-11_15-55-49.png)

登录『新浪云控制台』，点击云应用，点击『创建新应用』

![选择 NodeJS 填写二级域名和应用名称](/images/v1/nodejs-sinacloud_2018-02-11_15-58-54.png)

选择 NodeJS 填写二级域名和应用名称。实例个数推荐设置为 1。注意 Node.js 项目是按小时收费的。

![选代码管理](/images/v1/nodejs-sinacloud_2018-02-11_16-01-20.png)
...
![创建数据库](/images/v1/nodejs-sinacloud_2018-02-11_16-02-03.png)
